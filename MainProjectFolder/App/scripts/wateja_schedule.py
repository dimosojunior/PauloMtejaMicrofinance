    ...
    try:
        ...
        for mteja in wateja_list:
            ...
            if mteja.Aina and mteja.Aina.Aina == "Muajiriwa":
                ...
                up_to_date = mteja.Up_To  # Hakikisha Up_To ni DateField katika modeli yako

                if not up_to_date:
                    continue  # Ruka mteja ambaye hana tarehe ya Up_To

                

                if up_to_date == today and not mteja.Nje_Ya_Mkata_Leo and mteja.JumlaYaDeni > 0:
                    condition_checked["nje_ya_mkataba_leo"] += 1
                ...
                if (today - up_to_date).days == 1 and mteja.Nje_Ya_Mkata_Leo:
                ...
                if (today - up_to_date).days == 1 and not mteja.Nje_Ya_Mkata_Wote and mteja.JumlaYaDeni > 0:
                ...
                if (today - up_to_date).days == 10 and mteja.Nje_Ya_Mkata_Wote and mteja.JumlaYaDeni > 0:
                    ...
                    Interval_ya_malipo_yote = (mteja.Interval or 0)
                    Interval_ya_malipo_yote = int(Interval_ya_malipo_yote)

                    kiasi_cha_riba_iliyojazwa = (mteja.Kiasicha_Riba_Kwa_Muda_Wa_Mkopo or 0)
                    ...
                    riba_mpya = int((kiasi_anachokopa * kiasi_cha_riba_iliyojazwa) / 100)
                    ...
                    tarehe_ya_kumaliza = mteja_created_date + timedelta(days=mwisho_wa_malipo_days)
                    ...
                    mteja.Created = mteja_created_date
